        ...
        <div className="container">
          ...
          <div className="row">
            <div className="col-md-6 col-sm-6 fh5co-service to-animate">
              <i className="icon to-animate-2 fas fa-heartbeat"></i>
            ...
            <div className="col-md-6 col-sm-6 fh5co-service to-animate">
              <i className="icon to-animate-2 fas fa-dumbbell"></i>
            ...
            <div className="col-md-6 col-sm-6 fh5co-service to-animate">
              <i className="icon to-animate-2 fas fa-robot"></i>
            ...
            <div className="col-md-6 col-sm-6 fh5co-service to-animate">
              <i className="icon to-animate-2 fas fa-cloud-meatball"></i>
            ...
            <div className="col-md-6 col-sm-6 fh5co-service to-animate">
              <i className="icon to-animate-2 fas fa-sync-alt"></i>
