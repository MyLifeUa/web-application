                ...
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-sm-6 fh5co-service to-animate">
                            ...
                            <p>When a user wants to have feedback about his crossfit training, he can record and send it to our servers in order to be processed. With the help of <strong>OpenPose</strong> software, we can check if a certain exercise was done correctly or not. <br />We will use <strong>Flask</strong> to develop this module.</p>
                        </div>
                        <div class="col-md-6 col-sm-6 fh5co-service to-animate">
